// for passing data values to another page
function transferValues(){
    ...
    localStorage.setItem("agevalue", ageValue);
    var weightValue = document.getElementById("weight").value;
    localStorage.setItem("weightvalue", weightValue);
    var heightValue = document.getElementById("height").value;
    localStorage.setItem("heightvalue", heightValue);
    var activityStatus = document.getElementById("activity").value;
    localStorage.setItem("activitystatus", activityStatus);
    return false;
}

//After passing data into a calorie tracker for adding meal and calories
